                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                    <input id="keterangan" name="keterangan" type="date" class="form-control" value="<?= $row['keterangan'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="pasien_id" class="col-4 col-form-label">Kelurahan ID</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row">
                                    <label for="dokter_id" class="col-4 col-form-label">Kelurahan ID</label>
                                    <div class="col-8">
